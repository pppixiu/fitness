                ...
                courseList
                    .map(function (item, index) {
                        html += '<div class="shizhan-course-wrap l ">'
                            ...
                            + item.id
                            + '"><img class="shizhan-course-img" alt="'+ item.user.username+'" src="'
                            + item.url
                            + '"></a>'
...
$('#tagname-list').on(
    ...
    function (e) {
        if ($(e.target).hasClass('btn-success')) {
            ...
            $(e.target).removeClass('button-default').addClass('btn-success').siblings()
...
$('#level-field').on(
    ...
    function (e) {
        if ($(e.target).hasClass('btn-success')) {
            ...
            $(e.target).removeClass('button-default');
            $(e.target).addClass('btn-success').siblings()
                .removeClass('btn-success').addClass('btn-default');
        }
        $('#course-list').empty();
        pageNum = 1;
...
function clear(){
    $("#tagname-list .btn").removeClass("btn-success");
    $("#level-field .btn").removeClass("btn-success");
}
