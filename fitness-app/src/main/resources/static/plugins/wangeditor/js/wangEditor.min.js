!function (e, t) {
    ...
    L.prototype = {
        constructor: L, _alert: function (e, t) {
            ...
            if (e) {
                ...
                n.cmd.do("insertHTML", '<img src="' + e + '" style="max-width:20%;"/>');
    ...
    j.prototype = {
        constructor: j, _initConfig: function () {
            ...
            null == i ? (a = o("<div></div>"), s = o("<div></div>"), d = n.children(), n.append(a).append(s), a.css("background-color", "#f1f1f1").css("border", "none"), s.css("border", "none").css("border-top", "none").css("min-height","auto")) : (a = n, s = o(i), d = s.children()), l = o("<div></div>"), l.attr("contenteditable", "true").css("width", "100%").css("height", "100%"), d && d.length ? l.append(d) : l.append(o("<p><br></p>")), s.append(l), a.addClass("w-e-toolbar"), s.addClass("w-e-text-container"), s.css("z-index", r), l.addClass("w-e-text");
